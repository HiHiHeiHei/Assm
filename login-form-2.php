...
<?php include 'header-2.php' ?>
    <?php
        ...
        $conn = new mysqli('database1.cc3ywdjisoyb.us-east-1.rds.amazonaws.com', 'admin', 'Assm1234', 'database1', '3306');
...
<!--                                            <div class="form-check">
                            ...
                            <div class="col-md-5 ps-0 d-none d-md-block">
                                <div class="form-right h-100 text-white text-center pt-5">
                                    <img class="logo" src="picturefolder/logo.png" alt="TARUMT Gradify Logo" style="width: 400px; height: 100px;" />
                                </div>
                            </div>
                        </div>
                    </div>
